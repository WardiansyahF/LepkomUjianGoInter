...
func dbConn() (db *sql.DB) {
	dbDriver := "mysql"
	dbName := "ujian_go" //diubah sesuai nama db
	dbUser := "root"
	dbPass := ""
...
func main() {
	...
	srv := &http.Server{
		Handler:      r,
		Addr:         "127.0.0.1:8014", //silahkan ubah 2 digit terakhir port dengan 2 digit npm terakhir masing"
		WriteTimeout: 15 * time.Second,
		ReadTimeout:  15 * time.Second,
	}

	log.Print("Server berjalan di http://127.0.0.1:8014") //silahkan ubah 2 digit terakhir port dengan 2 digit npm terakhir masing"
	srv.ListenAndServe()
}
